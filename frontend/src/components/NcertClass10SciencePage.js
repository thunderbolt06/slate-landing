...
export default function NcertClass10SciencePage() {
  ...
  useEffect(() => {
    document.title = "NCERT Class 10 Science – All Chapters | SlateUp AI";
    const metas = [
      { name: "description", content: "Master NCERT Class 10 Science with AI-powered interactive classrooms. Covers all 13 chapters — Chemical Reactions to Our Environment — with step-by-step explanations and practice." },
      { name: "keywords", content: "NCERT Class 10 Science, CBSE Class 10 Science, Class 10 Science chapters, Chemical Reactions, Acids Bases Salts, Life Processes, Electricity, Light Reflection Refraction, NCERT solutions" },
      { property: "og:title", content: "NCERT Class 10 Science – All Chapters | SlateUp AI" },
      { property: "og:description", content: "Learn all 13 NCERT Class 10 Science chapters interactively with AI on SlateUp. Ask questions, get explanations, and practise problems — free." },
