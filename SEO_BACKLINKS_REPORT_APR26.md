...
Three new SEO-optimized posts have been written and committed locally. Run the following from the `slate-landing` directory to push them to GitHub:

```bash
cd slate-landing
git add frontend/content/blog/ai-learning-apps-for-college-students-2026.md \
        frontend/content/blog/how-to-study-effectively-with-ai-science-backed-2026.md \
        frontend/content/blog/ai-tools-for-upskilling-professionals-2026.md \
        frontend/src/generated/blogRegistry.js
git commit -m "feat: add 3 SEO blog posts (Apr 26, 2026)"
...
## 20 Priority Directory Submissions for Today
...
|---|-----------|------------|-------|
| 1 | **Futurepedia** | https://www.futurepedia.io/submit-tool | Largest AI directory, 1M+ monthly visitors |
| 2 | **There's An AI For That** | https://theresanai.com/submit | High DA, education category |
| 3 | **Toolify.ai** | https://www.toolify.ai/submit | Auto-updated daily, good for EdTech |
| 4 | **TopAI.tools** | https://topai.tools/submit | Clean UX, fast indexing |
| 5 | **AI Scout** | https://aiscout.net/submit-tool | Free listing with backlink |
| 6 | **FutureTools** | https://www.futuretools.io/submit-a-tool | Large audience, Matt Wolfe's newsletter reach |
| 7 | **Altern.ai** | https://altern.ai/submit | Good DA, featured in ai-directories list |
| 8 | **The Next AI** | https://www.thenextai.com/submit-ai-tool/ | Free listing, dofollow backlink, 120k+ monthly visitors |
...
| # | Directory | Submit URL | Notes |
|---|-----------|------------|-------|
| 15 | **Product Hunt** | https://producthunt.com | Launch or claim listing; massive SEO value |
| 16 | **Best of Web** | https://www.bestofweb.site | Free dofollow backlink, fast approval |
| 17 | **Dofollow.Tools** | https://dofollow.tools | Explicit dofollow backlinks |
| 18 | **AI Toolz Dir** | https://www.aitoolzdir.com | DR 27 backlink, free |
...
| # | Resource | URL | Action |
|---|----------|-----|--------|
| B1 | **best-of-ai/ai-directories** | https://github.com/best-of-ai/ai-directories | Submit PR to add slateup.ai as an AI education tool |
| B2 | **mahseema/awesome-ai-tools** | https://github.com/mahseema/awesome-ai-tools | Submit PR under Education category |
| B3 | **AI Agents Directory** | https://aiagentsdirectory.com | Submit as AI agent/learning platform |

---

## Guest Posting Targets (Longer-Term Backlinks)
...
## Running Cumulative Submissions Log

To track which directories have been submitted, maintain this log:
